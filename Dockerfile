...
RUN set -x \
    && curl -Ls -o ${CONFLUENCE_INSTALL}/lib/postgresql-9.4-1201.jdbc41.jar https://jdbc.postgresql.org/download/postgresql-9.4-1201.jdbc41.jar
